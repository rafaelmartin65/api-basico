<!--<header>
 <div class="row">
    <div id="preheader" class="container-fluid col-12 text-center">
        <a class="text-white" href="#">Listado de contactos de la Empresa</a>
    </div> 
  </div>
...
<header class="p-3 mb-3 border-bottom">
  <div class="container">
    <div class="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
      ...
      <ul class="nav col-12 col-lg-auto me-lg-auto mb-2 justify-content-center mb-md-0">
        ...
        <li><a href="#" class="nav-link px-2 link-dark">Contactos</a></li>
      </ul>
  ...
  <div class="row">
    <div id="preheader" class="container-fluid col-12 text-center bg-primary p-4 h-100">
      <a class="text-white" href="#">Listado de contactos de la Empresa</a>
    </div>
  </div>
